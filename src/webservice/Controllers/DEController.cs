...
namespace OpenPlzApi.DE
{
    ...
    public class DEController : BaseController
    {
        ...
        /// </summary>
        /// <param name="key">Regional key of the federal state</param>
        ...
        /// </summary>
        /// <param name="key">Regional key of the government region</param>
        /// <returns>List of districts</returns>
        ...
        /// </summary>
        /// <param name="key">Regional key of the district</param>
        ...
        /// <summary>
        /// Returns all municipalities (Gemeinden) within a municipal associations (Gemeindeverband).
        /// </summary>
        /// <param name="key">Regional key of the municipal association</param>
        /// <returns>List of municipalities</returns>
        [HttpGet("MunicipalAssociations/{key}/Municipalities")]
        [Produces("text/json", "application/json")]
        public async Task<IEnumerable<MunicipalityResponse>> GetMunicipalitiesByAssociationAsync(string key)
        {
            return await _dbContext.Set<Municipality>()
                .Include(x => x.Association)
                .Include(x => x.District)
                .Where(x => x.Association.RegionalKey == key)
                .OrderBy(x => x.RegionalKey)
